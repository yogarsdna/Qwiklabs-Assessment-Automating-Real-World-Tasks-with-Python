...
if __name__ == "__main__":
    ...
    3. The file path of the PDF to be generated as the attachment argument (use ‘/tmp/processed.pdf')
    """
    ...
    2. To: username@example.com
    3. Replace username with the username given in the Connection Details Panel on the right hand side
    4. Subject line: Upload Completed - Online Fruit Store
    5. E-mail Body: All fruits are uploaded to our website successfully. A detailed list is attached to this email
    6. Attachment: Attach the path to the file processed.pdf
    """
